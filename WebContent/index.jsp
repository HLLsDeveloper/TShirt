...
<head>
	...
	<link rel="stylesheet" href="resources/css/style.Loading.css">
	...
	<script type="text/javascript" src="resources/js/script.Loading.js"></script>
</head>
<body>
	<c:import url="resources/template/modal.Loading.jsp"/>
	<div id="content">
